...
// This script will move and flip your character as necessary.
// Your character will be controlled by mouse clicks or by taps on the touch screen
    ...
    void FixedUpdate ()
    {
        if (WalkTarget)
        {
            ...
            if (WalkTarget.transform.position.x < transform.position.x - walkAccuracy && !collidingWallLeft)
            {
                ...
                rb2d.MovePosition(rb2d.position + new Vector2(-walkSpeed * Time.fixedDeltaTime, 0f));
